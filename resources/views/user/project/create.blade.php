...
@section('content')
    <div class="container create-project">
        <form id="form-project" action="{{ route('user.project.store') }}" method="post" enctype="multipart/form-data" >
            <div class="header-banner">
                <div class="title-page">
                    <span class="personal-page"><a href="{{ route('user.my_page.index') }}">{{ trans('common.title.personal_page') }}</a>・</span>
                    <span class="text-subtitle">{{ trans('common.title.create_project') }}</span>
                </div>
                <div class="show-pc">
                    <button type="submit" class="btn btn-success submit-form-data">{{ trans('common.button.project_post') }}</button>
                </div>
            </div>
            @include('user.project.fields', ['project' => null])
            <div class="show-pc">
                <div class="d-flex justify-content-center submit-form-end" >
                    <button type="submit" class="btn btn-success submit-form-data">{{ trans('common.button.project_post') }}</button>
                </div>
            </div>
        </form>
