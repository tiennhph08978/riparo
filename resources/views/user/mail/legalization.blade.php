                        ...
                        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td style="padding:0 35px;">
                                    <p>{!! str_replace(['{no}', '{target_amount}', '{url}'],
                                        [\App\Helpers\ProjectHelper::formatId($project->id), $project->target_amount,\App\Helpers\UrlHelper::getProjectAdminlink($project)],
