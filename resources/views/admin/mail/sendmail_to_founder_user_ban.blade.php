...
<div style="background:#fff; width:100%;margin:auto; word-break: break-all">
    <div style="padding:20px">
        <p><span style="font-weight: 700">{{ $project->user->first_name }}</span>様</p>
        <p>{!! \App\Helpers\StringHelper::formatContent($emailTemplate->header) !!}</p>
        <p>{!! str_replace(['{no}','{url}','{Fullname}'],
                            [\App\Helpers\ProjectHelper::formatId($project->id),\App\Helpers\UrlHelper::getProjectlink($project), $fullName],
